 ...
 * Description:       Syncs easyVerein members to Basecamp 3, handles project application form + Strawpoll voting flow, plus event and room request forms.
 * Version:           2.1.0
 * Requires PHP:      8.1
 * Author:            Florian Lenz
