...
class Bcc {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Bcc_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Bcc_Loader. Orchestrates the hooks of the plugin.
	 * - Bcc_i18n. Defines internationalization functionality.
	 * - Bcc_Admin. Defines all hooks for the admin area.
	 * - Bcc_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bcc-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bcc-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-bcc-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-bcc-public.php';
	 ...
	 *
	 * Uses the Bcc_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_nopriv_addUser', $plugin_ajax, 'addUser' );
		$this->loader->add_action( 'wp_ajax_addUser', $plugin_ajax, 'addUser' );

		$this->loader->add_action( 'wp_ajax_nopriv_removeUser', $plugin_ajax, 'removeUser' );
		$this->loader->add_action( 'wp_ajax_removeUser', $plugin_ajax, 'removeUser' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Bcc_Loader    Orchestrates the hooks of the plugin.
	 */
